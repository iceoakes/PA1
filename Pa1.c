...
int main(void)
{
    ...
    int i=0;
     ...
     printf("Enter 3 to encrypt using substitution cipher\n ");
     printf("Enter 4 to decrypt using substitution cipher\n ");
     printf("Selection: ");
     
     scanf("%d",&a);//scans user input to put into switch statements
